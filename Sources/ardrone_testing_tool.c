/**
 * @file ardrone_record_video_with_measurements.c
 * @author Yury Fettser fettsery@gmail.com
 * @date 2014/12/18
 *
 * Recording video and data measurements (roll, tangage, yaw, height) to file (h.264 frames)
 * 
 * Possible args :
 * -e filename : name of output file
